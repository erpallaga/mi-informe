      ...
      >
        <div className="flex h-16 items-center justify-around px-2">
          ...
          <button
            ...
            className="flex items-center justify-center w-14 h-14 bg-primary text-on-primary text-2xl font-light shadow-ambient -translate-y-4 transition-opacity ease-out"
          >
            +
          </button>
